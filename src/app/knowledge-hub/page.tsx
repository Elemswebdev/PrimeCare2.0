    ...
    <>
      <style>{`
        ...
        .kh-card:hover {
          ...
          box-shadow: 0 24px 48px -12px rgba(13,61,56,0.18);
        ...
        .kh-card:hover .kh-arrow-btn {
          background: #0D3D38; color: #FAF7F0; transform: translateX(3px);
        }
        ...
        /* Show floating card only on md+ */
        .kh-hero-card { display: none; }
        ...
        */
        ...
        /* ── HERO padding ──
           Less top/bottom breathing room on small screens
        */
        .kh-hero-inner {
          max-width: 1280px;
          margin: 0 auto;
        ...
        @media (min-width: 768px) {
          .kh-hero-inner { padding: 7rem 1.5rem 6rem; }
        }
        ...
        @media (min-width: 768px) {
          .kh-intro-section { padding: 6rem 1.5rem 5rem; }
        }
        ...
        @media (min-width: 768px) {
          .kh-grid-section { padding: 0 1.5rem 6rem; }
        }
      ...
      >
        ...
        >
          ...
          <div className="kh-hero-inner">
            ...
            {/* Hero grid — single col mobile, two col md+ */}
            <div className="kh-hero-grid">
              ...
              <div>
                ...
                {/* CTA visible on mobile instead of the floating card */}
                <Link
                  href="/contact-us"
                  className="kh-featured-cta kh-reveal"
                  style={{
                    marginTop: "1.75rem",
                    display: "inline-flex",
                    alignItems: "center",
              ...
              {/* Right: floating stat card — hidden on mobile via CSS */}
              <div
                className="kh-hero-card kh-reveal"
        ...
        >
          ...
          >
            ...
            >
              ...
              keeping residents safe. Read at your own pace, or call and
        ...
        {/* ============ ARTICLE GRID ============ */}
        <section className="kh-grid-section">
          <FadeUp style={{ maxWidth: "1180px", margin: "0 auto" }}>
            <div className="kh-article-grid">
              {/* Featured card */}
              <Link
                href={featured.href}
